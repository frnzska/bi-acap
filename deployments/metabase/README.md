Metabase provides easy deploy on [Heroku](https://www.metabase.com/docs/latest/operations-guide/running-metabase-on-heroku.html) for testing but no Athena driver provided.
